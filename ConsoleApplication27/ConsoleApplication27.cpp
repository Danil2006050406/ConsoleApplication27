...
int main() {
    ...
    dictionary["добрий день"] = "good day";
    dictionary["яблуко"] = "apple";
    dictionary["мова"] = "language";
    ...
    map<string, string>::iterator it = dictionary.find(ukrWord);

    
    if (it != dictionary.end()) {
        cout << "Англійський відповідник: " << it->second << endl;
    }
    else {
